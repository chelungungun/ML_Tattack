...
def random_target_(dataset, min_a, batch_id, batch_size, classifier_name, random_seed, mode):
	np.random.seed(random_seed)
	dataset_predcorrect = dataset + "correct_test"
	li_creepware , li_voc2012 , li_planet = [0 , 1 , 2 , 3 , 4 , 5 , 6 , 7] , [0 , 1 , 2 , 3 , 7 , 9 , 11 , 12 , 13 , 14 , 16 ,
	                                                                   18] , [2 , 3 , 4 , 6 , 7 , 10 , 11 , 14 , 15]
	lc_creepware , lc_voc2012 , lc_planet = [8 , 9 , 10 , 11 ,12,13,14,15] , [4 , 5 , 6 , 8 , 10 , 15 , 17 , 19] , \
										[0 , 1 , 5 , 8 , 9 , 12 , 13 , 16]
...
def random_target_AB(dataset, min_a, batch_id, batch_size, classifier_name, random_seed, mode):
	np.random.seed(random_seed)
	dataset_predcorrect = dataset + "correct_test"
	# li_creepware , li_voc2012 , li_planet = [0 , 1  , 4 , 5 , 6 , 7] , [0 , 1 , 2 , 3 , 7 , 9 , 11 , 12 , 13 , 14 , 16 ,
	#                                                                    18] , [2 , 3 , 4 , 6 , 7 , 10 , 11 , 14 , 15]
	# lc_creepware , lc_voc2012 , lc_planet = [8 , 9 , 10 , 11 ,12,13,15] , [4 , 5 , 6 , 8 , 10 , 15 , 17 , 19] , \
	# 									[0 , 1 , 5 , 8 , 9 , 12 , 13 , 16]
	# # la_creepware , la_voc2012 , la_planet = [2 , 3 , 7, 6] , [4 , 5 , 15 , 19] , \
	# #                                         [1 , 5 , 9 , 16]
	# # lB_creepware , lB_voc2012 , lB_planet = [4, 8,9,10,11,12,13,14,15] , [6 , 8 , 10 , 17] , \
	# #                                         [0 , 8 , 12 , 13]
	...
	# 	ind_B = np.sort(b[0:min_a])
		...
		# 	ind_A = np.array([1,2,3,4])
		# 	ind_B = np.array([0,5,6,7])
...
def corre_target(dataset, batch_id, batch_size, classifier_name):
	### The label set with high correlation
	# creepware: []
	# voc2012: []
	# planet: []
